...
# Input: phenotype - supplied through command line
FILE_PHENO=$1
...
# Output folder - supplied through command line
DIR_OUT=$2
...
# However, due to machine memory size, the maximum number of batch
#   not causing an error is significantly lower
N_BATCH_MAGMA=4
