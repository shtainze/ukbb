...
# Input: GWAS result
FILE_GWAS_RESULT="$DIR_ANALYSIS_RESULT_SPECIFIC""analysis_20230705_01_gwas/all/out.1180-0.0.glm.linear"

# Output
DIR_OUT_ROOT="$DIR_ANALYSIS_RESULT_SPECIFIC""analysis_20230727_01_pgs_test/"
