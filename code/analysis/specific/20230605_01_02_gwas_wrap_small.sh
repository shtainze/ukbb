...
#single "$DIR_SOURCE""1234_plink.txt" "1180-0.0_Chronotype_fourway_small" "small"
single "$DIR_SOURCE""12_34_plink.txt" "1180-0.0_Chronotype_twoway_small" "small"
#single "$DIR_SOURCE""1_4_plink.txt" "1180-0.0_Chronotype_definite_small" "small"

# BMI - small
DIR_SOURCE="$DIR_DATA_ACCEL_UKBB_PLINK"
single "$DIR_SOURCE""ukb671006_12155_21001-0.0.txt" "21001-0.0_BMI_small" "small"
