...
# Output folder
DIR_OUT="$DIR_ANALYSIS_RESULT_SPECIFIC""analysis_20230526_02_triple_crispr_ode_san/1/"
...
N_GENES=$(wc -l "$FILE_GENES" | awk '{print $1}')

echo ""
echo $(date) "Start processing" "$N_GENES" "genes"
echo ""
...
sort "$FILE_GENES" > "$FILE_GENES_SORTED"
