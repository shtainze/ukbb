...
function func_single (){
    ...
    bash "$file_code" "$file_pheno" "$dir_out" "$pheno_name" > "$file_log" 2>&1
}
...
function single3 (){
    pheno=$1
    file_pheno="$DIR_DATA_ACCEL_UKBB_PLINK_ACCEL""$pheno"".txt"
    func_single "$file_pheno" "21index" "$pheno"
}

single3 30816_ST_long_mean
single3 30817_ST_long_sd
single3 30818_WT_long_mean
single3 30819_WT_long_sd
single3 30820_ST_short_mean
single3 30821_ST_short_sd
single3 30822_WT_short_mean
single3 30823_WT_short_sd
single3 30824_long_window_len_mean
single3 30825_long_window_len_sd
single3 30826_long_window_num_mean
single3 30827_long_window_num_sd
single3 30828_short_window_len_mean
single3 30829_short_window_len_sd
single3 30830_short_window_num_mean
single3 30831_short_window_num_sd
single3 30832_phase_mean
single3 30833_phase_sd
single3 30834_max_period
single3 30835_amplitude
single3 30836_sleep_percentage